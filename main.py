...
# 🍓 Allow cross-device logins (Android / iPhone / browsers)
...
# 🍓 FIX: make session cookies mobile-friendly
app.config.update(
    SESSION_COOKIE_SAMESITE="None",   # required for fetch() with credentials
    SESSION_COOKIE_SECURE=True,       # force HTTPS-style cookie
    SESSION_COOKIE_HTTPONLY=True,     # keeps cookie secure
)
